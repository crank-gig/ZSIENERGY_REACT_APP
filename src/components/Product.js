...
const Products = () => {
    ...
    return (
        <div>
            ...
            <main>
                {/*<!--Product page brief-->*/}
                <div className="product-page-brief">
                    <div class="product-hero-image-wrapper">
                        <img 
                            src={placeholderImage}
                            img-src="https://res.cloudinary.com/dhbj763qc/image/upload/v1716998707/zsienergy/shivendu-shukla-3yoTPuYR9ZY-unsplash_exssny.jpg" 
                            alt="Hero Thumbmnail"
                            lazy=""
                        />
                        <div className="slide-caption">
                            <div className="slide-caption-sub1" role="heading" aria-level="1">
                                Your Partner in Industrial Innovation
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="heading-text" role="heading" aria-level="2">
                            <span className="green-highlight">Building for the best</span>
                        </div>
                        <p>
                ...
                <section className="our-policies" aria-labelledby="our-policies-heading">
                    ...
                    <div className="policy-entry" aria-labelledby="nigerian-content-policy-heading">
                        <div 
                            id="nigerian-content-policy-heading" 
                            className="subheading-text"
                            role="heading"
                            aria-level="3"
                        >
                ...
                <div className="oqmp" role="region" aria-labelledby="quality-management-policy-heading">
                    <section>
                        <div 
                            className="heading-text" 
                            id="quality-management-policy-heading"
                            role="heading"
                            aria-level="3"
                        >
                        ...
                        <div className="oqmp-entry-wrapper">
                            <div data-aos="fade-up" className="oqmp-entry" role="article" aria-label="Customer Satisfaction">
                            ...
                            <div data-aos="fade-up" className="oqmp-entry" role="article" aria-label="Inspections and Testing">
                            ...
                            <div data-aos="fade-up" className="oqmp-entry" role="article" aria-label="Systematic Actions">
                            ...
                            <div data-aos="fade-up" className="oqmp-entry" role="article" aria-label="Analysis and Evaluation">
