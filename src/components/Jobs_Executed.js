                    ...
                    <div className="tbody">
                        ...
                        <div className="trow">
                            <div className="trow-view">
                                ...
                                <div className="trow-view3">
                                    <button
                                    onClick={() => dropDesc("dropdown-butt7", "process-detail7")}
                                    id="dropdown-butt7"
                                    aria-expanded={activeContractDetail === "process-detail7"}
                                    aria-controls="process-detail7"
                                    >
                                        <img src="https://res.cloudinary.com/dhbj763qc/image/upload/v1716271804/zsienergy/custom_table_dropdown_icon_r5wqpy.svg" alt="dropdown icon" />
                                    </button>
                                </div>
                            </div>
                            <div className="trow-dropdown" id="process-detail7" aria-hidden={activeContractDetail !== "process-detail7"}>
                                <div className="trow-dropdown-heading">
